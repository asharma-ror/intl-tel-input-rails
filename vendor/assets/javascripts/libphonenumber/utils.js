(function() {
    ...
    var L = {
        ...
        sa = {
            ...
            CL: [, [, , "(?:[2-9]|600|123)\\d{7,8}", "\\d{7,11}"],
                ...
                [, , "NA", "NA"],
                [, , "44\\d{7}", "\\d{9}", , , "441234567"], "CL",
                56, "(?:0|1(?:1[0-69]|2[0-57]|5[13-58]|69|7[0167]|8[018]))0", "0", , , "0|(1(?:1[0-69]|2[0-57]|5[13-58]|69|7[0167]|8[018]))", , , , [
    ...
    */
    ...
    m("intlTelInputUtils", {});
    m("intlTelInputUtils.formatNumber", function(a, b, c, d, e) {
        try {
            var f = a.replace(/\D/g, ""),
                g = new Ra(b),
                h = "",
            ...
            if (c && !a.split(" ext. ")[1]) {
                ...
                if (isNaN(parseFloat(p.substr(p.length - 2, 1)))) return p.substr(0,
                    p.length - 1);
